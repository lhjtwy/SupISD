...
#' @param breaklength a numeric value giving the length between break points.
#'        Default is 1.
...
supisd <- function(data, breakstart = NULL, breakend = NULL, breaklength = NULL,
  ...
  if (!is.null(breaklength) == FALSE) {breaklength <- 1}

  breakset<-seq(breakstart,breakend,breaklength)
